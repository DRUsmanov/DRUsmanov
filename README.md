## C++ Backend Developer
Разрабатываю высоконагруженные и низкоуровневые системы на C++. Фокус на производительность, многопоточность и архитектуру.
## Технологии и инструменты
![c++](https://shields.fly.dev/badge/C%2B%2B-STL%3A%2017%2F20%2C%20Boost-brightgreen)

![psql](https://shields.fly.dev/badge/PostgreSQL-14.20-green)

![docker](https://shields.fly.dev/badge/Docker-29.1.5-orange)

![cmake](https://shields.fly.dev/badge/CMake-4.1.2-blue)

![qt](https://shields.fly.dev/badge/Qt-6%20-yellow)
...
[The System Project](https://github.com/DRUsmanov/the_system_project) - проект по разработке системы управления производственными цехами для нефтеперерабатывающей компании. Направлен на оптимизацию работы производственных цехов. Оценочный охват клиентов на старте проекта - 100 человек.
